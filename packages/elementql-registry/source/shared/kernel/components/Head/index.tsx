...
const Head: React.FC<HeadProperties> = (
    ...
    const titleValue = title || `elementql`;
    const descriptionValue = description || 'query web elements at browsertime';
    const ogTitleValue = ogTitle || title || `elementql`;
    const ogDescriptionValue = ogDescription || description || 'query web elements at browsertime';
    const ogImageValue = ogImage || '/icon-192x192.png';
    const ogURLValue = ogURL || 'https://elementql.org';

    const apiDomain = 'https://elementql.org';
